...
# Execute the script with the whatif
#Write-Host "Executing the function with -WhatIf" -ForegroundColor Magenta
#Invoke-DemoCreateFiles -FileCount $fileCount -Destination $destination1, $destination2 -DeleteFiles -WhatIf

# Because of the loop I can now do this
Write-Host "Executing the function with Confirm" -ForegroundColor Magenta
$ConfirmPreference = "High" # Setting the confirm preference to low to get the message
Invoke-DemoCreateFiles -FileCount $fileCount -Destination $destination1, $destination2 -DeleteFiles

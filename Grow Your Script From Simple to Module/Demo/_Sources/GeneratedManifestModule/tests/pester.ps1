...
Remove-Module GeneratedManifestModule -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\GeneratedManifestModule.psd1"
Import-Module "$PSScriptRoot\..\GeneratedManifestModule.psm1" -Force
